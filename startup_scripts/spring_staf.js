StartupEvents.registry("item", event => {
    ...
    .setTier(tier => {
        tier.useBaseTier("ARTIFICER", true)  // 使用工匠模板
            .addAttribute("irons_spellbooks:holy_spell_power", 0.5, "add_multiplied_total")   
            .addAttribute("irons_spellbooks:blood_spell_power", -0.8, "add_multiplied_total") 
            .addAttribute("irons_spellbooks:ice_spell_power", -0.8, "add_multiplied_total")  
            .addAttribute("irons_spellbooks:ender_spell_power", -1.0, "add_multiplied_total")  
            .addAttribute("irons_spellbooks:fire_spell_power", 0.15, "add_multiplied_total")  
            .addAttribute("irons_spellbooks:nature_spell_power", 0.5, "add_multiplied_total")  
            .addAttribute("irons_spellbooks:evocation_spell_power", -1.0, "add_multiplied_total")  
            .addAttribute("irons_spellbooks:eldritch_spell_power", 0.1, "add_multiplied_total")
